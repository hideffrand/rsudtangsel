...
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Halo RSU Tangsel Care, saya ingin berkonsultasi mengenai pelayanan rumah sakit."
);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-auto">
      ...
      {isOpen && (
        <div
          className="
            w-80 sm:w-88 bg-background border border-border rounded-lg shadow-xl
            p-4 space-y-3 animate-[fadeIn_0.2s_ease-out] relative
          "
        >
          {/* Header Card */}
          <div className="flex items-center justify-between border-b border-border pb-3">
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center text-white font-bold text-sm shadow-xs">
                  RS
                </div>
                <span className="w-3 h-3 rounded-full bg-emerald-500 border-2 border-background absolute bottom-0 right-0 animate-pulse" />
              </div>
              <div>
                <h4 className="font-semibold text-foreground text-sm leading-tight">
                  Chatbot RSU Tangsel Care
                </h4>
                <p className="text-[11px] text-emerald-600 font-medium">Online 24/7 • WhatsApp</p>
              </div>
            </div>
            <button
          ...
          <a
            ...
            className="
              ...
              rounded-md shadow-sm hover:shadow transition-all
            "
          >
            {/* WhatsApp Icon */}
      ...
      <button
        ...
        "
        aria-label="Bantuan Chat WhatsApp"
      >
